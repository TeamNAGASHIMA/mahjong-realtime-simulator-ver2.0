...
DISCARD_REGIONS = {
    ...
    'bottom': {
        'center_x_ratio': 0.45,
        'center_y_ratio': 0.8, # 卓の中央よりやや下
        'width_ratio': 0.3,    # 牌が横に並ぶ幅
        'height_ratio': 0.3    # 牌が縦に積まれる高さ（通常3段まで）
    },
    # 2. 下家（画面右）の捨て牌
    'right': {
        'center_x_ratio': 0.72,  # 卓の中央よりやや右
        'center_y_ratio': 0.46,
        'width_ratio': 0.2,     # 牌が横に積まれる幅（通常3段まで）
        'height_ratio': 0.4     # 牌が縦に並ぶ高さ
    },
    # 3. 対面（画面上）の捨て牌
    'top': {
        'center_x_ratio': 0.47,
        'center_y_ratio': 0.18, # 卓の中央よりやや上
        'width_ratio': 0.3,
        'height_ratio': 0.3
    },
    # 4. 上家（画面左）の捨て牌
    'left': {
        'center_x_ratio': 0.19,  # 卓の中央よりやや左
        'center_y_ratio': 0.48,
        'width_ratio': 0.25,
        'height_ratio': 0.42
    }
...
if __name__ == '__main__':
    # --- テスト用設定 ---
    TEST_IMAGE_PATH = 'test_mahjong_high_2.jpg' # テスト用画像パス
